...
void loop() {
  for (int i=0; i<NUM_LEDS;i++){
      ...
      leds2[i] =  CRGB(255 ,30, 30);; FastLED.show(); delay(50);
  }
...
delay(1000);
 ...
 for (int i=0; i<NUM_LEDS;i++){
      leds[i] =  CRGB(130 ,255, 255);; FastLED.show(); delay(150);
       leds2[i] =  CRGB(130 ,255, 255);; FastLED.show(); delay(150);
  }
 
 delay(2000);
 for (int i=0; i<NUM_LEDS;i++){
      leds[i] =  CRGB(255 ,255, 255);; FastLED.show(); delay(150);
       leds2[i] =  CRGB(255 ,0, 0);; FastLED.show(); delay(150);
  }
 delay(2000);
...
delay(1000);
 for (int i=0; i<NUM_LEDS;i++){
      leds[i] =  CRGB(5 ,5, 5);; FastLED.show(); delay(200);
       leds2[i] =  CRGB(5 ,5, 5);; FastLED.show(); delay(200);
  }
